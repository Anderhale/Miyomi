    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-2 mb-1 flex-wrap">
          <h3 className="font-['Open Sans',sans-serif] text-[var(--text-primary)]" style={{ fontWeight: 600, fontSize: '16px' }}>
            {name}
          </h3>
        ...
        <p className="text-[var(--text-secondary)] font-['Open Sans',sans-serif] mb-2" style={{ fontSize: '14px' }}>
          {description}
        </p>
