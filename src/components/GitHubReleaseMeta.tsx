        ...
        <div className="flex flex-wrap items-center justify-center gap-1 sm:justify-start">
          {release.version && release.version !== 'N/A' && (
            <div className="inline-flex items-center gap-1.5 rounded-full border border-[var(--divider)] bg-[var(--chip-bg)] px-3 py-1.5">
              ...
              <span
                className="text-xs sm:text-sm text-[var(--text-primary)] font-['Open Sans',sans-serif]"
              ...
              {release.isPrerelease && (
                <span
                  className="ml-1 rounded-full border border-yellow-500/30 bg-yellow-500/10 px-2 py-0.5 text-[10px] sm:text-xs font-['Open Sans',sans-serif] text-yellow-600 dark:text-yellow-400"
                  style={{ fontWeight: 600 }}
                >
                  Pre-release
                </span>
          ...
          <div className="inline-flex items-center gap-1.5 rounded-full border border-[var(--divider)] bg-[var(--chip-bg)] px-3 py-1.5">
            ...
            <span
              className="text-xs sm:text-sm text-[var(--text-secondary)] font-['Open Sans',sans-serif]"
...
export function GitHubReleaseNotes({
  ...
  const wrapperClasses = `prose prose-sm max-w-none text-[var(--text-secondary)] font-['Open Sans',sans-serif] ${className}`.trim();
